...
*/
		...
		cv::inRange(img, cv::Scalar(43,81,100), cv::Scalar(102,167,205), feat_img);
		img_to_show = feat_img;
		cv::putText(img_to_show, "Image Path: " + img_path, cv::Point(5, 65), cv::FONT_HERSHEY_SIMPLEX, 0.5, cv::Scalar(255, 100, 0), 2);
		cv::imshow("Yellow regions", img_to_show);
		cv::waitKey(0);
	}
